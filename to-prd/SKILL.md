...
3. Write the PRD using the template below, then produce a PRD artifact that can be pasted into the project issue tracker. Apply the `ready-for-agent` triage label - no need for additional triage.
